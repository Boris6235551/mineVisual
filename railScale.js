...
var _a = require('electron').remote, dialog = _a.dialog, BrowserWindow = _a.BrowserWindow;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fl = dialog.showSaveDialogSync(BrowserWindow.getFocusedWindow(), {
                    ...
                    console.log('file path', fl);
                    return [4 /*yield*/, exportToExc(reportData, fl)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function exportToExc(reportData, fileName) {
    return __awaiter(this, void 0, void 0, function () {
        var workbook, worksheet, i, rowNumber, cell;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
//# sourceMappingURL=railScale.js.map