...
var vPoints = [
    ...
    [43, 180, mine_drawing_1.Disposition.Vertical],
...
var UNDEGROUNDPUMP = /** @class */ (function (_super) {
    ...
    function UNDEGROUNDPUMP(container, width, height, basePoint, number) {
        ...
        _this.number = number;
        _this.name = (number > 0 && number < 4) ? ('drainageA') : ('drainageB');
        _this.items = [];
    ...
    UNDEGROUNDPUMP.prototype.createWidgets = function (p, number) {
        ...
        this.Pool1 = new pumpAccessories_1.Pool(new mine_drawing_1.Point(400, 550), 900);
